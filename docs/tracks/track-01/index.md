...
| Fields | Details |
|-------|--------|
| **Products** | [watsonx Orchestrate](https://www.ibm.com/products/watsonx-orchestrate)<br> [watsonx.governance](https://www.ibm.com/products/watsonx-governance) <br> [IBM Bob](https://bob.ibm.com/) |
...
```mermaid
flowchart LR
    theory["<strong>Theory</strong><br/>What & Why"] --> lab101["<strong>Lab 101</strong><br/>Basics"]
