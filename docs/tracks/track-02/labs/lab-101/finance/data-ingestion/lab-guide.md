...
1. On the **Ingest data: Storages** page, use the **Select storage** dropdown to choose your COS bucket.
2. Set the **Select type** dropdown to `csv`.
3. The file browser will display the contents of your bucket. Check the box next to your CSV file.
